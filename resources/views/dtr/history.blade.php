                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <form method="POST" action="{{ route('dtr.delete', $report->report_id) }}" style="display: inline;" onsubmit="console.log('Form submitted for report:', {{ $report->report_id }}); return confirm('Are you sure you want to delete this DTR report? This action cannot be undone.');">
                                                @csrf
                                                @method('DELETE')
