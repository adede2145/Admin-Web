...
<head>
    ...
    <style>
        ...
        .aa-nav .nav-link { color:#ffdfe0; padding:.75rem 1.5rem; width:100%; display:flex; align-items:center; justify-content:flex-start; flex-direction:row; text-align:left; gap:.75rem; font-weight:400; line-height:1.2; }
        .aa-nav .nav-link i { color: var(--aa-yellow); font-size:1.25rem; margin-right:0; flex-shrink:0; }
